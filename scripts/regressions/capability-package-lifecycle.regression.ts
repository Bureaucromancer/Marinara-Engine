...
try {
  ...
  assert.deepEqual(supportedCapabilityApi, { major: 1, minor: 19 });
  ...
  assert.match(
    ...
    /requires capability API 2\.0; this Engine supports 1\.19/,
  );
  ...
  assert.match(
    ...
    /requires capability API 1\.20; this Engine supports 1\.19/,
  );
